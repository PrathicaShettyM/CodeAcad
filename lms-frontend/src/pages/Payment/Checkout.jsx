    ...
    async function handleSubscription(e){
        ...
        const options = {
            ...
            handler: async function(response){
                ...
                res?.payload?.success ? navigate("/checkout/success") : ("/checkout/fail");
            }
        };
        ...
        <HomeLayout>
            <form onSubmit={handleSubscription} className="min-h-[90vh] flex items-center justify-center text-white">
                <div className="w-80 h-[26rem] flex flex-col justify-center shadow-[0_0_10px_black] rounded-lg relative">
                    <h1 className="bg-yellow-500 absolute top-0 w-full text-center py-4 text-2xl font-bold rounded-tl-lg rounded-rt-lg">Subscription Bundle</h1>
                </div>
                <div className="px-4 space-y-5 text-center">
                    <p className="px-4 space-y-5 text-center">
