...
// we are collecting all these data so that we can show them on the admin dashboard
const initialState = {
    key: "",
    subscription_id: "",
...
// some async thunks
// getRazorPayId: to get razorpay key
...
// set up new subscription id for our upcoming subscription 
